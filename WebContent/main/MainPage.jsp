...
%>
      ...
      <div class="homeMainContent">
        ...
        <div>
          ...
          <div class="homeButtons">
            ...
            <a class="homeButton textL textBold ml3" href="../Trade/index.jsp" >믿을 수 있는 중고거래</a>
          </div>
        </div>
      </div>
    </section>
 ...
 <section class="cards-wrap">
    	...
    	<c:set var="fileList" value="${fboardDAO.selectListAll(keyWord)}"/>
	    	<c:forEach var="item" items="${fileList}" varStatus="status" begin="0" end="7">
